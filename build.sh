...
log "(Optional) Use [zygisk-detach](https://github.com/j-hc/zygisk-detach/releases/latest) to detach root Morphe YouTube and YouTube Music from the Play Store\n"
